package com.elixirsoft.feature;
...
public class Application {
	...
	public Map<String, Integer> result = new HashedMap<String, Integer>();
	
	public static void main(final String[] args) {
		log.info("Starting application...");
		final CommandLineArguments arguments = CommandLineArguments.builder().build();
		final JCommander commander = JCommander.newBuilder().addObject(arguments).programName("myapp").build();
